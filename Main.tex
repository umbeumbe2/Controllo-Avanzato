...
\usepackage{enumitem}                     % << aggiunto
\setlength{\parskip}{0pt}                 % niente spazio extra tra paragrafi
\setlength{\parindent}{0pt}               % (opzionale) rientro paragrafo a zero
\setlist[itemize]{noitemsep,topsep=0pt,parsep=3pt,partopsep=0pt,itemsep=0pt} % elenchi compatti
