...
la specifica  è potente 
ma non necessaria, infatti possiamo accontentarci delle seguenti specifiche:
\begin{equation}
    \begin{cases}
        \| S(s)(R(s) - D(s))\|_{2} \to 0  \\
        \| T(s) N(s)\|_{2} \to 0 
...
\right\|_\infty < \gamma
 ...
 Per noi il problema di mixed sensitivity è considerato risolto
 se e solo se \(\gamma < 1\).
